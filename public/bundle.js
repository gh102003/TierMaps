        ...
        this.getJSON = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = (_b.sent());
                        responseData = data.reduce(function (acc, item) { var _a; return __spread(acc, ((_a = item === null || item === void 0 ? void 0 : item.data) !== null && _a !== void 0 ? _a : [])); }, []);
                        _a = {
                            data: responseData,
...
},{"axios":4,"moment":30}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var UKCovid19_1 = require("./UKCovid19");
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return UKCovid19_1.default; } });

},{"./UKCovid19":2}],4:[function(require,module,exports){
...
},{"@publichealthengland/uk-covid19":3}],32:[function(require,module,exports){
require("./map.js");
},{"./map.js":33}],33:[function(require,module,exports){
